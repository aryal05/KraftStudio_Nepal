          ...
          <div className="flex items-center justify-between h-16">
            ...
            <Link href="/">
              <div className="flex items-center gap-2 cursor-pointer">
                ...
                <div className="flex flex-col">
                  <span className="font-serif text-base font-bold text-gray-900 tracking-wide">
                    KRAFTSTUDIO
                  </span>
                </div>
              </div>
            ...
            <a href="tel:+9779769682175">
              <div className="relative">
                <div className="relative w-12 h-12 bg-[#8b7355] text-white rounded-full flex items-center justify-center shadow-lg">
