...
const defaultMaterials = ["Leather", "Fabric", "Wood", "Velvet", "Metal"];
const defaultStyles = ["Modern", "Contemporary", "Scandinavian", "Classic", "Minimalist"];
...
export default function ProductListing() {
  ...
  const configCategories = config.subcategories;
        ...
        <section className="py-8 bg-white border-b border-gray-200 sticky top-0 z-40 shadow-sm">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
              {configCategories.map((cat: { name: string; icon: any; count: number }, index: number) => (
                  ...
                  <Card className="p-6 bg-white shadow-lg border-0">
                    ...
                    <div className="mb-8">
                      ...
                      <div className="space-y-3">
                        {configMaterials.map((material: string) => (
