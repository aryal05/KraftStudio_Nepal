...
const productList = [
  { id: 1, name: "Cooper, Kristin", image: "/api/placeholder/40/40", price: "$119.92", stock: 34, sold: 340, active: true },
  { id: 2, name: "Mid-Century Lounge Chair", image: "/api/placeholder/40/40", price: "$299.00", stock: 12, sold: 156, active: true },
  { id: 3, name: "Minimalist Desk Lamp", image: "/api/placeholder/40/40", price: "$89.50", stock: 45, sold: 203, active: false },
  { id: 4, name: "Scandinavian Coffee Table", image: "/api/placeholder/40/40", price: "$449.99", stock: 8, sold: 87, active: true },
];
                ...
                <div className="mt-4 p-4 bg-emerald-50 rounded-lg border border-emerald-100">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      <p className="text-lg font-bold text-emerald-600" style={{ fontFamily: "'JetBrains Mono', 'Roboto Mono', 'SF Mono', monospace", fontVariantNumeric: "tabular-nums" }}>$53.5k</p>
                      <p className="text-xs text-gray-500 mt-1">Aug 12, 2024</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-3">
                  ...
                  {productList.map((product) => (
                    ...
                    >
                      ...
                      <span className="text-sm text-gray-700" style={{ fontFamily: "'JetBrains Mono', 'Roboto Mono', 'SF Mono', monospace", fontVariantNumeric: "tabular-nums" }}>{product.price}</span>
